...
public class Network implements Serializable {
    ...
    private  double ExE;
    private int cant_imp;
    private double ET;

    public Network(double [][] patron,double[][] v_espe, int [] capasOcultas, int funcion, double alpha, long iteraciones, double errorMinimo, int cant_imp){
        this.patron = patron;
